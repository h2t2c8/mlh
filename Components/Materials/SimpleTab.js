...
const styles = StyleSheet.create({
    ...
    borderTopRightRadius:8,borderRightWidth:1,borderRightColor:'#fff', fontSize:13,
                    borderTopWidth:1,borderTopColor:'#fff',color:'#333',paddingTop:10,paddingBottom:10,flex:2,textAlign:'center', fontWeight:'bold'},
    TabHeading:{ fontSize:13,borderTopLeftRadius:10,borderTopRightRadius:10,backgroundColor:'#f5baff',borderBottomWidth:2,borderBottomColor:'#fff',paddingTop:10,paddingBottom:10,flex:2,textAlign:'center',color:'#000', fontWeight:'bold' }
});